const blogs = [
  {
    ...
    <pre className="bg-gray-100 p-4 rounded-lg mb-6 no-scrollbar overflow-x-auto">
      <code>{\`// Example of a code snippet inside your blog
function greet(name) {
  return "Hello, " + name + "!";
}\`}</code>
    </pre>
...
function calculateTotal(price, tax) {
  ...
  isPublished: true,
  profile: "https://i.pinimg.com/736x/2b/13/88/2b138832cbb7ef215c4f46e0a4d0c663.jpg",
  thumbnail: "https://i.pinimg.com/736x/1e/3a/bb/1e3abbba11a871a37db7d8ad8ee92a08.jpg"
},
{
  id: "3",
  title: "How to Start a Successful Online Business",
...
function waterIntake(weightKg) {
  ...
  isPublished: true,
  profile: "https://i.pinimg.com/736x/6d/92/f4/6d92f4a0cb36047ad1d808ad96c0da44.jpg",
  thumbnail: "https://i.pinimg.com/736x/bc/d6/c7/bcd6c73e26f781b4b438e991e01e7859.jpg"
},
{
  id: "6",
...
function compoundInterest(principal, rate, years) {
  ...
  isPublished: true,
  profile: "https://i.pinimg.com/736x/0f/0d/43/0f0d43b3d1f8abf8af55edeb4e63e14a.jpg",
  thumbnail: "https://i.pinimg.com/736x/32/51/54/3251549c9c0c9af01ff3a6f5a2a0a6a1.jpg"
},
{
  id: "7",
...
function practiceCoding() {
  ...
  updatedAt: "Aug 22, 2025",
  isPublished: true,
  profile: "https://i.pinimg.com/736x/b1/aa/29/b1aa29b7c1a0e8a7503c7f47e56ec8c3.jpg",
  thumbnail: "https://i.pinimg.com/1200x/20/51/f3/2051f3c25b849ee9f3b8bc886a18d642.jpg"
},
{
  id: "10",
...
function recommendMovie(userPreference) {
  ...
  isPublished: true,
  profile: "https://i.pinimg.com/736x/5d/0d/f2/5d0df2289ecabc50c6aa4f1cf003eb09.jpg",
  thumbnail: "https://i.pinimg.com/1200x/5a/93/3b/5a933b01f26c6fb3275ed12f34d3e9b5.jpg"
}
